  ...
  return (
    <div className="h-screen  w-full bg-pastelpink  overflow-x-hidden"> 
        ...
        <div className="h-80 w-46  mt-20">
         ...
         <Link to={"/sign-up" }  className=" h-12 w-40 rounded-3xl bg-pastelblue text-pastelgray ml-4 flex justify-center items-center text-sm font-semibold">Registrate</Link>
         ...
         <Link to={"/login"} className="h-12 w-36  rounded-3xl bg-pastelred text-pastelgray flex justify-center items-center text-sm font-semibold">Inicia Sesión</Link>
         </div>
         </div>
         <div className=' w-64 ml-auto mr-auto'>
            <h5 className='relative  text-gray-400 font-semibold '>Quieres iniciar sesión o registrarte?</h5>
         </div>
    </div>
  )
}
