...
function PostItemMenu({ id, classList, disabledState, setDisabledState }) {
  ...
  return (
    <div className={`${classList} absolute right-16`}>
      ...
      <form className={`${warningState ? '' : 'hidden'} fixed z-50 right-0 left-0 top-0 bottom-0 flex flex-col justify-center items-center gap-6 m-auto max-w-lg h-60 bg-white rounded-xl`}>
